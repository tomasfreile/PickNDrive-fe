...
export function MyBookings({ bookings, onReviewClick, title = "Bookings", emptyMessage = "No bookings found." }: MyBookingsProps) {
  return (
    <Card>
      <CardHeader>
      ...
      <CardContent>
        {bookings.length === 0 ? (
          ...
          <div className="space-y-4">
            ...
            <Link key={booking.id} href="/booking-details" className="block">
