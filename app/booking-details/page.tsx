...
function BookingDetailsContent() {
  ...
  const bookingId = searchParams.get("id") || "BK-2024-001"
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-sm">
                    ${booking.pricing.dailyRate}/day × {booking.pricing.totalDays} days
                  </span>
...
// Main component with Suspense boundary and Navbar
export default function BookingDetailsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <Suspense
        fallback={<div className="flex items-center justify-center min-h-screen">Loading booking details...</div>}
      >
